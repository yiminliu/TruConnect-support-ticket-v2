...
public class TicketService implements TicketServiceModel {
	...
	public static void main(String[] args){
		...
		Ticket custTicket = new CustomerTicket();
		custTicket.setCategory(TicketCategory.ACCOUNT_SETTINGS);
		custTicket.setCreatedDate(custTicket.getCreatedDate());
		custTicket.setStatus(TicketStatus.OPEN);
		custTicket.setDescription("This is a test");
		try{
  		  ts.createTicket(custTicket);
		}
		catch(Exception e){
  			 e.printStackTrace();
  		 }
